...
<li><a href="#" id="traficob">Trafico</a></li>
 ...
 <source src="videos/CRC.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'CRC.jsp' "<h4>CRC</h4></a></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
 <source src="videos/CRC 2.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'CRC 2.jsp' "<h4>CRC 2</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
</table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/CRC 3.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'CRC 3.jsp' "<h4>CRC 3</h4></a></center></td>
  </tr> 
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/EMPAK.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'EMPAK.jsp' "<h4>EMPAK</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/EMPAK 2.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'EMPAK 2.jsp' "<h4>EMPAK 2</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/Lineales2.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Lineales 2.jsp' "<h4>Lineales 2</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
        <br>
        <center><h4><a href="#" id="ventas" onclick="location.href='ventas.jsp'">1</a>,<a href="#" id="ventas2" onclick="location.href='ventas2.jsp'">2</a>,<a href="#" id="ventas" onclick="location.href='ventas3.jsp'">3</a>,4,<a href="#" id="ventas5" onclick="location.href='ventas5.jsp'">5</a>,<a href="#" id="ventas2" onclick="location.href='ventas6.jsp'">6</a>,<a href="#" id="ventas" onclick="location.href='ventas7.jsp'">7</a></h4></center>
    </center>
</body>
</html>