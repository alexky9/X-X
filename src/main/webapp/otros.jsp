...
<li><a href="#" id="traficob">Trafico</a></li>
  ...
  <source src="videos/Carreta.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'carreta.jsp' "<h4>La carreta</h4></a></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/puente.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'puente.jsp' "<h4>El puente</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
</table>
