...
<li><a href="#" id="traficob">Trafico</a></li>
 ...
 <source src="videos/reductores.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Reductores.jsp' "<h4>Reductores</h4></a></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/reductores 2.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Reductores2.jsp' "<h4>Reductores 2</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
</table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/rodamientos.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Rodamientos.jsp' "<h4>Rodamientos</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
</table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/rodamientos2.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Rodamientos2.jsp' "<h4>Rodamientos 2</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>  
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/RODILLOS.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Rodillos.jsp' "<h4>Rodillos</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table> 
  ...
  <tr>
    <td width="160" rowspan="2">
   <video  width="150" height="80" preload >
  <source src="nsk1.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'NSK2.jsp' "<h4>NSK 2</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
        <br>
            <center><h4><a href="#" id="ventas" onclick="location.href='ventas.jsp'">1</a>,<a href="#" id="ventas2" onclick="location.href='ventas2.jsp'">2</a>,<a href="#" id="ventas" onclick="location.href='ventas3.jsp'">3</a>,<a href="#" id="ventas4" onclick="location.href='ventas4.jsp'">4</a>,<a href="#" id="ventas5" onclick="location.href='ventas5.jsp'">5</a>,6,<a href="#" id="ventas" onclick="location.href='ventas7.jsp'">7</a></h4></center>
    </center>
</body>
</html>
