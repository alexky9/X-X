...
<li><a href="#" id="traficob">Trafico</a></li>
 ...
 <source src="videos/capacitacion.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Capacitacion.jsp' "<h4>Capacitacion</h4></a></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
 <source src="videos/capacitacion 2.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Capacitacion2.jsp' "<h4>Capacitacion 2</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
</table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/capacitacion 3.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Capacitacion3.jsp' "<h4>Capacitacion 3</h4></a></center></td>
  </tr> 
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/MC GILL.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'MCGILL.jsp' "<h4>MC GILL</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/MTE.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'MTE.jsp' "<h4>MTE</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/R+W.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'RW.jsp' "<h4>R+W</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
   </table>
        <br>
        <center><h4><a href="#" id="ventas" onclick="location.href='ventas.jsp'">1</a>,<a href="#" id="ventas2" onclick="location.href='ventas2.jsp'">2</a>,<a href="#" id="ventas" onclick="location.href='ventas3.jsp'">3</a>,<a href="#" id="ventas" onclick="location.href='ventas4.jsp'">4</a>,5,<a href="#" id="ventas2" onclick="location.href='ventas6.jsp'">6</a>,<a href="#" id="ventas" onclick="location.href='ventas7.jsp'">7</a></h4></center>
    </center>
</body>
</html>