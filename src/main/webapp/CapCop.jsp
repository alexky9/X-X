...
<source src="videos/CAPACITACION COPLES.webm"  type='video/webm; codecs="vp8,vorbis"' />
</video>
    </center>
        <form method="Post" class="log">
            <center>
                <input type="button" onclick=" location.href='http://localhost:8080/Tutoriales/ventas2.jsp' " value="Atras" name="Atras" /> 
            </center>
 </form>
</body>
</html>