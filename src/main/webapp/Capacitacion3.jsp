...
<source src="videos/capacitacion 3.webm"  type='video/webm; codecs="vp8,vorbis"' />
</video>
    </center>
        <form method="Post" class="log">
            <center>
                <input type="button" onclick=" location.href='http://localhost:8080/Tutoriales/ventas5.jsp' " value="Atras" name="Atras" /> 
            </center>
 </form>
</body>
</html>