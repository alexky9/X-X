...
$(document).ready(function() {
  ...
  <source src="videos/Archivado.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Archivado.jsp' "<h4>ARCHIVADO</h4></a></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/Seguimiento.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Seguimiento.jsp' "<h4>SEGUIMIENTO</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
</table>
  ...
  <tr>
    <td width="160" rowspan="2">
   <video width="150" height="80" preload>
  <source src="videos/Firma.webm" type="video/webm">
</video>
    </td>
      <td width="660"><center><a href="#" onClick="location.href = 'Firma.jsp' "<h4>FIRMA</h4></a></center></td>
  </tr>
  <tr>
      <td width="660"><h5>Descripcion del video-------Descripcion del video------Descripcion del video</h5></tr>
</table>
